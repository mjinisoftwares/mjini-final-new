...
export default async function Projects() {
  ...
  return (
    <div className="relative pt-12 md:pt-24 lg:pt-36">
      <h2 className="text-center text-4xl md:text-5xl py-8 font-bold bg-gradient-to-br from-foreground via-foreground to-foreground/70 bg-clip-text text-transparent mb-12">
